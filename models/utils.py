...
from models.singlecell import Singlecell
...
def parse_args():
    ...
    parser.add_argument("--embedder", type=str, default="MoDET")
    parser.add_argument("--dataset", type=str, default="quake_10x_spleen", help="Name of the dataset.")
    ...
    parser.add_argument("--layers", nargs='?', default='[1999]', help="The number of units of each layer of the GNN. Default is [256]")
    parser.add_argument("--pred_hid", type=int, default=1999, help="The number of hidden units of layer of the predictor. Default is 512")
...
def decide_config(root, dataset):
    ...
    if dataset == "quake_10x_bladder":
        ...
        params = {"kwargs": {"root": root, "name": dataset, "filepath": filepath},
                  "name": dataset, "class": Singlecell, "src": "pyg"}
    elif dataset == "kolodziejczyk":
        dataset = "kolodziejczyk"
        root = osp.join(root, "pyg")
        filepath = "./test_csv/kolodziejczyk/data.csv"
        params = {"kwargs": {"root": root, "name": dataset, "filepath": filepath},
                  "name": dataset, "class": Singlecell, "src": "pyg"}
    else:
        raise Exception(
